<template>
  ...
  <div>
    <div class="mt-14 md:p-4 p-2 flex flex-col">
      ...
      <Table2 :buttonValue="buttonValue" :table2_fill="table2_fill" :getDataFromPresent="getDataFromPresent" ></Table2>
      <Table3 :buttonValue="buttonValue" :table3_fill="table3_fill"></Table3>
