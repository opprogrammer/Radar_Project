...
const collection = mongo?.db("radar").collection("table2");
// functions

const props = defineProps({
  getDataFromPresent:Function,
  getDate1:Function,
  table2_fill:Function,
  buttonValue:Boolean,
})
const contacts = ref([]);

onMounted(()=>{
  props.table2_fill(contacts.value);
...
// var tb2l=document.getElementById("tb2");
// if(tb2l.row.length===0){
//   console.log("table2 empty");
// }
</script>
